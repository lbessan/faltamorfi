...
function DepartmentBlock({
  ...
  return (
    <section className="space-y-2">
      <h2 className="flex items-center gap-2 text-base font-heading font-bold text-foreground">
        <span className="inline-flex items-center justify-center size-8 rounded-full bg-primary/15 text-primary">
          <DynamicIcon
